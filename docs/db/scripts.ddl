...
ALTER TABLE T_HTK_ALIMENTO ADD CONSTRAINT T_HTK_ALIMENTO_USUARIO_FK FOREIGN KEY ( fk_id_usuario ) REFERENCES T_HTK_USUARIO ( id_usuario ) ON DELETE CASCADE;
...
ALTER TABLE T_HTK_ATV_FISICA ADD CONSTRAINT T_HTK_ATV_USUARIO_FK FOREIGN KEY ( fk_id_usuario ) REFERENCES T_HTK_USUARIO ( id_usuario ) ON DELETE CASCADE;
ALTER TABLE T_HTK_PESO ADD CONSTRAINT T_HTK_PESO_USUARIO_FK FOREIGN KEY ( fk_id_usuario ) REFERENCES T_HTK_USUARIO ( id_usuario ) ON DELETE CASCADE;
ALTER TABLE T_HTK_PRESSAO ADD CONSTRAINT T_HTK_PRESSAO_USUARIO_FK FOREIGN KEY ( fk_id_usuario ) REFERENCES T_HTK_USUARIO ( id_usuario ) ON DELETE CASCADE;
...
DROP SEQUENCE SQ_TB_ATV_FISICA;
DROP SEQUENCE SQ_TB_PESO;
DROP SEQUENCE SQ_TB_PRESSAO;
