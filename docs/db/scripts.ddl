...
CREATE SEQUENCE SQ_TB_ALIMENTO MINVALUE 1 START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SQ_TB_ATV_FISICA MINVALUE 1 START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SQ_TB_PESO MINVALUE 1 START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SQ_TB_PRESSAO MINVALUE 1 START WITH 1 INCREMENT BY 1;
CREATE SEQUENCE SQ_TB_USUARIO MINVALUE 1 START WITH 1 INCREMENT BY 1;
